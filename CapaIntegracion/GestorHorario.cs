...
namespace Resgistro_de_Matricula.CapaIntegracion
{
    public class GestorHorario : servicio, IDisposable
    {
        ...
        public string InsertarHorario(string Horario_descripcion, string Horarario_dia, string Horario_horaInicio,
           string Horario_horaFin, string Horario_estado)
        {
            Horario newHorario = new Horario(Horario_descripcion, Horarario_dia, Horario_horaInicio,
        ...
        public string ModificarHorario(int Horario_id,string Horario_descripcion, string Horarario_dia, string Horario_horaInicio,
           string Horario_horaFin, string Horario_estado)
        {
            Horario newHorario = new Horario(Horario_id, Horario_descripcion, Horarario_dia, Horario_horaInicio,
                Horario_horaFin, Horario_estado);
