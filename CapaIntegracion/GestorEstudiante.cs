...
namespace Resgistro_de_Matricula.CapaIntegracion
{
    public class GestorEstudiante : servicio, IDisposable
    {
        ...
        public string InsertarEstudiante(string Estudiante_cedula, string Estudiante_nombre, string Estudiante_primerApellido,
        ...
        {
            Estudiante newEstudiante = new Estudiante(Estudiante_cedula, Estudiante_nombre, Estudiante_primerApellido, Estudiante_segundoApellido,
        ...
        public string ModificarEstudiante(int Estudiante_id,string Estudiante_cedula, string Estudiante_nombre, string Estudiante_primerApellido,
           string Estudiante_segundoApellido, string Estudiante_Telefono, string Estudiante_correoElectronico,
           string Estudiante_direccion, string Estudiante_estado)
        {
            Estudiante newEstudiante = new Estudiante(Estudiante_id, Estudiante_cedula, Estudiante_nombre, Estudiante_primerApellido, Estudiante_segundoApellido,
                Estudiante_Telefono, Estudiante_correoElectronico, Estudiante_direccion, Estudiante_estado);
