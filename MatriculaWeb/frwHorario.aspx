            ...
            <asp:Panel ID="Panel1" runat="server" BackColor="#22577A">
                <table style="width:100%;">
                    ...
                    <tr>
                        ...
                        <td class="auto-style15">
                            <asp:Button ID="btnHorario_Modificar" runat="server" OnClick="btnHorario_Modificar_Click" Text="Modificar" />
                        </td>
                        <td>
                            <asp:Button ID="btnHorario_Eliminar" runat="server" OnClick="btnHorario_Eliminar_Click" Text="Eliminar" />
                        </td>
                    </tr>
                    <tr>
                        <td class="auto-style17">&nbsp;</td>
                    ...
                    <tr>
                        <td class="auto-style17">
                            <asp:Button ID="Button1" runat="server" OnClick="Menu_Click" Text="Menu" />
                        </td>
                        <td class="auto-style15">&nbsp;</td>
                        <td>&nbsp;</td>
                    </tr>
